  ...
  getMyPromotions(UserController usercontrol) async {
    ...
    firestore.collection("Announces").get().then((querySnapshot) {
      querySnapshot.docs.forEach((result) {
        ...
        DocumentReference dr = result['store'];
...
//   }
  ...
  addPro(
    ...
    bool isPro = false;
    String url =
        "https://firebasestorage.googleapis.com/v0/b/cun-app.appspot.com/o/defaults%2Fannonce.jpeg?alt=media&token=245f7402-5fcc-410f-b5c5-ac8dc2cc156c";
    if (type == "Promotion") {
      isPro = true;
    }
    if (file != null) {
      ...
      if (isPro) {
        url =
            "https://firebasestorage.googleapis.com/v0/b/cun-app.appspot.com/o/defaults%2Foffre.png?alt=media&token=807a8b86-246a-494f-9933-d2514847ac7d";
      }
    } else {}
    ...
    FirebaseFirestore.instance
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => MyPromotions()));
      update();
